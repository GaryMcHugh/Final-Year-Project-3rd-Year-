...
<body>
	...
	<%!public class Doctor {
		...
		public Doctor() {
			try {
				...
				insertDoctor = connection.prepareStatement(
		...
		public int setDoctor(String first, String last, String gender, String dob, String mobile, String home,
				String jobTitle) {
			int result = 0;
	...
	<div class="container">
		<form class="form-inline" name="myForm" action="AddDoctor.jsp"
			method="POST">
			<div class="row">
				...
				<div class="col-md-2">
					<div class="form-group">
						<br /> <label for="InputDoctor_ID">Doctor_Id:</label> <input
							class="form-control" id="InputDoctor_ID" placeholder="D12345"
							readonly>
					</div>

					<div class="form-group">
						<br /> <label for="InputFirstName">First Name:</label> <input
							class="form-control" name="first" id="InputFirstName"
							placeholder="Joe">
					</div>
					...
					<div class="form-group">
						<br /> <label for="InputMobileNo">Mobile-No: </label> <input
							class="form-control" name="mobile" id="InputMobileNo"
							placeholder="0871234567">
					</div>

					<div class="form-group">
						<br /> <label for="InputInjury">Job Title:
							&nbsp;&nbsp;&nbsp;</label> <select class="form-control" name="jobTitle">
				...
				<div class="col-md-2">
					<div class="form-group">
						<br /> <br /> <br /> <br /> <br /> <label for="InputLastName">Last
							Name: </label> <input class="form-control" name="last" id="InputLastName"
							placeholder="Bloggs">
					</div>
					...
					<div class="form-group">
						<br /> <label for="InputHomeNo">Home-No: </label> <input
							class="form-control" name="home" id="InputHomeNo"
							placeholder="09512345">
					</div>
