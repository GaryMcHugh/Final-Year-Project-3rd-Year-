...
<body>
	...
	<%!public class Patient {
		...
		public int setPatient(String first, String last, String gender, String dob, String mobile, String home,
				String injury, String doctor) {
			int result = 0;
	...
	<div class="container">
		<form class="form-inline" name="myForm" action="AddPatient.jsp"
			method="POST">
			<div class="row">
				...
				<div class="col-md-2">
					<div class="form-group">
						<br /> <label for="InputPatient_ID">Patient_Id:</label> <input
							class="form-control" id="InputPatient_ID" placeholder="P12345"
							readonly>
					</div>
				...
				<div class="col-md-2">
					...
					<div class="form-group">
						<br /> <label for="InputDoctorName">Doctor: </label> <input
							class="form-control" name="doctor" id="InputDoctorName"
