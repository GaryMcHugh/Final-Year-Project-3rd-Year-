	...
	public class Patient
	{
		...
		public Patient(){
			try {
				...
				selectPatients = connection.prepareStatement("SELECT PatientID, FirstName, LastName, Gender, DOB, MobileNo, HomeNo, Injury, DoctorName FROM patient");
		...
		<form class="form-inline" action="DeletePatient.jsp" method="POST">
			...
			<div class="col-md-2">
			  <div class="form-group">
		  		<br />
			    <label for="InputPatient_ID">Patient's:</label>
   					<select class="form-control" name="patient">
   					<% while (patients.next()){%>
			  			<option value="<%= patients.getInt("PatientID") %>"><%= patients.getString("FirstName") %> <%= patients.getString("LastName") %></option>
			  			<% } %>
					</select>
			  </div>
			    ...
			    <input class="form-control" id="InputFirstName" type="text" placeholder="Joe" readonly>
			  </div>
			    ...
			    <label for="InputMobileNo">Mobile-No:    </label>
   			    <input class="form-control" id="InputMobileNo" type="text" placeholder="0871234567" readonly>
			  </div>
			  
   				<div class="form-group">
	   			  	<br />
	 			  	<label for="InputInjury">Injury: &nbsp;&nbsp;&nbsp;</label>
					<select class="form-control" name="injury" readonly>
			...
			<div class="col-md-2">
			    ...
			    <input class="form-control" id="InputLastName" type="text" placeholder="Bloggs" readonly>
			  </div>
			  
  			  <div class="form-group">
		  		<br />
			    <label for="InputDOB">Date Of Birth:    </label>
			    <input class="form-control" id="InputDOB" type="text" placeholder="YYYYMMDD" readonly>
			  </div>
			  
   			  <div class="form-group">
		  		<br />
			    <label for="InputHomeNo">Home-No:    </label>
			    <input class="form-control" id="InputHomeNo" type="text" placeholder="09512345" readonly>
			  </div>
			  
   			  <div class="form-group">
		  		<br />
			    <label for="InputDoctorName">Doctor:    </label>
			    <input class="form-control" id="InputDoctorName" type="text" placeholder="Joe Bloggs" readonly>
			  </div>
			</div>
