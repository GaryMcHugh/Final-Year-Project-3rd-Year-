...
<%
	if (session.getAttribute("connection") == null) {
		 ...
		 */
		Connection connection = DriverManager.getConnection(application.getInitParameter("DATABASE_ENDPOINT"),
				application.getInitParameter("DB_USERNAME"), application.getInitParameter("DB_PASSWORD"));
...
<body>
	<div class="container">
		<img src="MediDB.png" width="250" height="100" alt="" /> <br />
		...
		<form class="form-inline" name="myForm" action="docDisplay.jsp"
			method="POST">
			<div class="pull-right">
				<label for="InputSearch">Search: </label> <input type="text"
					name="id" class="form-control" id="InputSearch"
			...
			<table class="table table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="DeleteDoctor.jsp">
								<button type="button" class="btn btn-default">
									<img src="delete.png" width="20" height="20" alt="" />
								</button>
						</a> <a href="AddDoctor.jsp">
								<button type="button" class="btn btn-default">
									<img src="add.png" width="20" height="20" alt="" />
								</button>
						</a></td>
					</tr>
					<%
