	...
	public class Doctor
	{
		...
		public Doctor(){
			try {
				...
				selectDoctors = connection.prepareStatement("SELECT DoctorID, FirstName, LastName, Gender, DOB, MobileNo, HomeNo, JobTitle FROM doctor");
		...
		<form class="form-inline" action="DeleteDoctor.jsp" method="POST">
			...
			<div class="col-md-2">
			  <div class="form-group">
		  		<br />
			    <label for="InputDoctor_ID">Doctor's:</label>
   					<select class="form-control" name="doctor">
   					<% while (doctors.next()){%>
			  			<option value="<%= doctors.getInt("DoctorID") %>"><%= doctors.getString("FirstName") %> <%= doctors.getString("LastName") %></option>
			  			<% } %>
					</select>
	  		  </div>
			    ...
			    <input class="form-control" id="InputFirstName" type="text" placeholder="Joe" readonly>
  				...
  				<div class="form-group">
  					...
  					<label for="InputGender">Gender: &nbsp;&nbsp;&nbsp;</label>
	   			  	<br />
					<select class="form-control" id="InputGender" type="text" readonly>
					</select>
				</div>
			    ...
			    <input class="form-control" id="InputMobileNo" type="text" placeholder="0871234567" readonly>
   				...
   				<div class="form-group">
	 			  	...
	 			  	<label for="InputInjury">Job Title: &nbsp;&nbsp;&nbsp;</label>
	   			  	<br />
					<select class="form-control" name="jobTitle" readonly>
