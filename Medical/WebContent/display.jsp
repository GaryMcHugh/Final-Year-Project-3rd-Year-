	...
	public class Patient
	{
		...
		public Patient(){
			try {
				...
				selectPatient = connection.prepareStatement("SELECT PatientID, FirstName, LastName, Gender, DOB, MobileNo, HomeNo, Injury, DoctorName FROM patient WHERE PatientID = ?");
